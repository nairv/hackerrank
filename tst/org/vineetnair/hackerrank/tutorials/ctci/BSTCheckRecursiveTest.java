...
import static org.vineetnair.hackerrank.tutorials.ctci.BSTCheckRecursive.Node;
 ...
 * vineet.
 */
public class BSTCheckRecursiveTest {

    private BTNode root;

    private BSTCheckRecursive sut = new BSTCheckRecursive();
